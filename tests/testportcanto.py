...
class TestGenerarDataset(unittest.TestCase):
    ...
    def test_valorsmitjatp(self):
        ...
        arr_tp = [row["temps_pujada"]
                  for row in arr]  # la columna tp és la segona
...
class TestClustersCiclistes(unittest.TestCase):
    ...
    ciclistes_data_clean = ciclistes_data_clean.drop(
        'tipus', axis=1)  # eliminem el tipus, ja no interessa
